...
var web = preload("res://assets/enemies/snow_spider/Spider_Web.tscn")
var web_net = preload("res://assets/enemies/snow_spider/Web_Net.tscn").instance()
...
func accelerate_towards_point(point, delta):
	var dir = position.direction_to(point) * 3
	velocity = velocity.move_toward(dir * MAX_SPEED, ACCELERATION * 3.5)
...
func _on_Hurtbox_area_entered(area):
	...
	if --area.damage:
		...
		print("Snow Spider HP: ", stats.health)
